...
> Bài AI vẫn hiển thị tách 3 hàng riêng (Đầu/Giữa/Cuối), nhưng ở trạng thái
> sấp trước khi người chơi xác nhận; chỉ sau khi xác nhận mới lật lên để so
> sánh.
...
| Trạng thái bài AI | Hiển thị ngay | Ở dạng sấp trước khi xác nhận, chỉ lật sau khi xác nhận |
